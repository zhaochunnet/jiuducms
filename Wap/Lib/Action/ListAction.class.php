...
class ListAction extends HomeAction{
    ...
    public function _before_index(){
    	...
    	$type = M('Arctype')->where('status =1 AND id='.$this->typeid)->field('cid,typename,seotitle,keywords,description,typeimg,content,ispart,tempindex,templist,typedir,listnum')->find();
    	if(!$type){
