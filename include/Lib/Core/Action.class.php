...
abstract class Action {
   ...
   /**
    ...
    protected function ajaxReturn($data,$type='') {
    	...
    	$result['statusCode']  =  (string)$data['status'];	// struggle@9ducx.com
    	$result['url']  =  $data['url'];	// struggle@9ducx.com
    	$result['navTabId']  =  $_REQUEST['navTabId'];	// struggle@9ducx.com
    	$result['rel']  =  $_REQUEST['rel'];	// struggle@9ducx.com
    	$result['callbackType']  =  $_REQUEST['callbackType'];	// struggle@9ducx.com
    	$result['forwardUrl']  =  $_REQUEST['forwardUrl'];	// struggle@9ducx.com
    	$result['confirmMsg']  =  $_REQUEST['confirmMsg'];	// struggle@9ducx.com
    	$result['message'] =  $data['info']; // struggle@9ducx.com
    ...
    private function dispatchJump($message,$status=1,$jumpUrl='',$ajax=false) {
        ...
        if($this->get('closeWin'))    $this->assign('jumpUrl','window.close();');
        ...
        if($status) { //发送成功信息
            ...
            // 默认发生错误的话自动返回上页
            if(!isset($this->jumpUrl)) $this->assign('jumpUrl',"history.back(-1);");
